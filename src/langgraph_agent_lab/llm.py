...
def get_llm(model: str | None = None, temperature: float = 0.0):
    ...
    if os.getenv("GEMINI_API_KEY"):
        ...
        return ChatGoogleGenerativeAI(
            model=model or os.getenv("LLM_MODEL") or os.getenv("DEFAULT_MODEL", "gemini-2.5-flash"),
    ...
    if os.getenv("OPENAI_API_KEY"):
        ...
        kwargs = {
            "model": model or os.getenv("LLM_MODEL") or os.getenv("DEFAULT_MODEL", "gpt-4o-mini"),
            "temperature": temperature,
        }
    ...
    if os.getenv("ANTHROPIC_API_KEY"):
        ...
        return ChatAnthropic(
            model=model or os.getenv("LLM_MODEL") or os.getenv("DEFAULT_MODEL", "claude-sonnet-4-20250514"),
            temperature=temperature,
        )
